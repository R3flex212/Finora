  ...
  return (
    <section className="relative">
      <ContainerScroll className="h-[350vh] bg-gradient-to-br from-[hsl(var(--deep-teal))] to-[hsl(var(--background))]">
        ...
        <ContainerScale className="relative z-10 text-center px-4 sm:px-8 lg:px-8">
          <h1 className="w-full md:max-w-3xl mx-auto text-4xl md:text-6xl font-bold tracking-tight text-foreground drop-shadow-lg">
          ...
          <p className="my-6 w-full md:max-w-2xl mx-auto text-base md:text-lg text-foreground/80 drop-shadow">
